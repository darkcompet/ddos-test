...
- Example
	...
	```bash
	# Test with default 10 connections
	autocannon https://ironsky-marketplace.darkcompet.com/

	# Detail test (-c 5 connections, -p 1 pipeline, -d 10 seconds or -a 100 requests, -w 4 request-threads)
	autocannon -c 5 -p 1 -d 10 -a 100 -w 4 https://ironsky-marketplace.darkcompet.com/
	```
